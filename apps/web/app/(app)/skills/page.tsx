...
export default function SkillMasteryMapPage() {
  ...
  const getMasteryColor = (score: number) => {
    ...
    if (score > 0)
      return { ring: 'text-red-500', bg: 'bg-red-500', label: 'text-red-600 dark:text-red-400' };
    return {
    ...
    return (
      <div className="container max-w-6xl py-8 space-y-8">
        <PageHeader
          ...
          description="Your evidence-based mastery across all skills."
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredSkills.map((skill) => {
          ...
          return (
            <Card
              key={skill.skill_id}
              className="hover:border-primary/30 transition-colors group overflow-hidden"
            >
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    className={`${statusConfig.bg} ${statusConfig.color} border-0 text-[10px]`}
                  >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-1.5 flex-1">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span
                        className={`font-mono font-semibold ${skill.retention_estimate < 0.5 ? 'text-red-500' : ''}`}
                      >
                        {(skill.retention_estimate * 100).toFixed(0)}%
                        {skill.retention_estimate < 0.5 && (
