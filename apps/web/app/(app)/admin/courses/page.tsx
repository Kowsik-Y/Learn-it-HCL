...
const mockCourses = [
  { id: "1", title: "Introduction to AI", teacher: "Alice Smith (teacher_01)", enrollment: 120, status: "Published" },
  { id: "2", title: "Advanced React", teacher: "Bob Jones (teacher_02)", enrollment: 85, status: "Draft" },
  { id: "3", title: "System Design basics", teacher: "Admin (Self)", enrollment: 0, status: "Draft" },
];
