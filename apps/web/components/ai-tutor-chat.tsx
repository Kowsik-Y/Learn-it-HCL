...
import { Bot, Mic, MicOff, Send, Volume2, VolumeX, X, MessageCircle } from "lucide-react";
...
export function AiTutorChat() {
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I'm your AI Tutor. Feel free to ask me any questions about the course material." }
  ]);
